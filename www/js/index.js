...
let register_account = function()
{
	...
	console.log('Registering ' + account.requested_alias + " [" + account.payment_data + "] by posting to https://cashaccount.info/alias"); 
	alert(postData('https://cashaccount.info/alias', JSON.stringify(account)));
}
